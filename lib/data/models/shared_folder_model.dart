...
class SharedFolderModel {
  ...
  static SharedFolder parseItem(Map<String, dynamic> data) {
    ...
    return SharedFolder(
      ...
      isHidden: data['hidden'] == true || data['is_hidden'] == true || data['hidden'] == 1,
      recycleBinEnabled: data['enable_recycle_bin'] == true || data['recyclebin'] == true || data['enable_recycle_bin'] == 1 || data['recyclebin'] == 1,
