      ...
      body: ListView(
        ...
        children: [
          ...
          const _SectionCard(
            ...
            subtitle: '按风险和依赖递进推进',
            items: [
              _StaticPanelItem(icon: Icons.schedule_rounded, title: '任务计划', subtitle: '第二阶段'),
              _StaticPanelItem(icon: Icons.usb_rounded, title: '外接设备', subtitle: '第二阶段'),
              _StaticPanelItem(icon: Icons.folder_shared_outlined, title: '共享文件夹', subtitle: '第二阶段'),
              _StaticPanelItem(icon: Icons.group_outlined, title: '用户与群组', subtitle: '第三阶段'),
              _StaticPanelItem(icon: Icons.dns_outlined, title: '文件服务', subtitle: '第三阶段'),
              _StaticPanelItem(icon: Icons.lan_outlined, title: '网络', subtitle: '第三阶段'),
            ],
          ),
          const SizedBox(height: 16),
          Container(
